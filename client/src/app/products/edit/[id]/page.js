// File: /client/src/app/products/edit/[id]/page.js
...
function EditProductPage() {
    ...
    const [isLoading, setIsLoading] = useState(true); // <-- Mulai dgn true
        ...
        if (id) {
            const fetchProductData = async () => {
                try {
                    ...
                    setFormData(data); // <-- Isi form dengan data dari API
                    setIsLoading(false);
                } catch (err) {
                    console.error(err);
    ...
    const inputStyle = "mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-black"; // <-- Tambah text-black
