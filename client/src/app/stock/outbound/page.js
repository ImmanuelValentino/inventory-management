// File: /client/src/app/stock/outbound/page.js
...
function StockOutboundPage() {
    ...
    useEffect(() => {
        const fetchMasterData = async () => {
            try {
                // Kita hanya butuh Produk dan Lokasi
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error('Failed to create stock outbound:', err);
    ...
    return (
        <main className="flex min-h-screen flex-col items-center p-24">
            <h1 className="text-2xl font-bold mb-4">Catat Stok Keluar (Outbound)</h1>
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-lg bg-white p-8 rounded-lg shadow-md">
                ...
                {/* Dropdown Lokasi */}
                <div className="mb-4">
                    <label htmlFor="location_id" className="block text-sm font-medium text-gray-700">Lokasi Ambil *</label>
                ...
                <div className="mt-6">
                    ...
                    >
                        {isLoading ? 'Menyimpan...' : 'Simpan Stok Keluar'}
                    </button>
                </div>
...
export default withAuth(StockOutboundPage);